addLayer("c", {
        ...
        baseResource: "tokenshards", // Name of resource prestige is based on
        ...
        effect() {
            return { // Formulas for any boosts inherent to resources in the layer. Can return a single value instead of an object if there is just one effec
        }},
